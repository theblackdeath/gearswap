...
_L['Weapon-Modes'] = { "Trishula","Shining One","Quint Spear", };
...
{
	['Ukonvasara'] = { false, false, false },
	['Trishula'] = { false, false, false },
};
...
windower.send_command('input //gs org')
	...
	sets['Idle']['Trishula'] = {main="Trishula", sub="Utu Grip",}
	sets['Idle']['Trishula']['Normal'] = set_combine(sets['Normal'],sets['Idle']['Trishula'] ,{})
	sets['Idle']['Trishula']['DT'] = set_combine(sets['DT'],sets['Idle']['Trishula'] ,{})
	...
	sets['Engaged']['Trishula']['Normal'] = {	
								main="Trishula",
								sub="Utu Grip",
								ammo="Ginsen",
								head="Flam. Zucchetto +2",
								body={ name="Valorous Mail", augments={'Accuracy+20 Attack+20','"Store TP"+5','DEX+10','Accuracy+8',}},
								...
								back={ name="Brigantia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}},
								};
					
									
	
	sets['Engaged']['Trishula']['Accuracy'] = {						
								main="Trishula",
								sub="Utu Grip",
								ammo="Ginsen",
								head="Flam. Zucchetto +2",
	...
	sets['WeaponSkill'] = {
								...
								body={ name="Valorous Mail", augments={'Accuracy+25 Attack+25','"Dbl.Atk."+4','STR+9','Accuracy+7','Attack+8',}},
								hands="Sulev. Gauntlets +2",
								legs={ name="Valor. Hose", augments={'Accuracy+14 Attack+14','"Dbl.Atk."+5','AGI+4','Attack+2',}},
								feet="Flam. Gambieras +2",
								neck="Fotia Gorget",
								waist="Fotia Belt",
								...
								back={ name="Brigantia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+8','"Dbl.Atk."+10',}},
								};
	...
	-- sets['WeaponSkill']['Drakesbane']['lugra_earring_set'] = set_combine(sets['WeaponSkill']['Drakesbane'], { left_ear="Lugra Earring +1",});
	...
	sets['WeaponSkill']['Camlann\'s Torment']['lugra_earring_set'] = set_combine(sets['WeaponSkill']['Camlann\'s Torment'], { left_ear="Lugra Earring +1",});
	
	-- sets['WeaponSkill']["Geirskogul"] = {				
								
								-- };

	-- sets['WeaponSkill']["Geirskogul"]['lugra_earring_set'] = set_combine(sets['WeaponSkill']["Geirskogul"], { left_ear="Lugra Earring +1",});
	...
	sets['WeaponSkill']['Sonic Thrust']['lugra_earring_set'] = set_combine(sets['WeaponSkill']['Sonic Thrust'], { left_ear="Lugra Earring +1",});
	...
	sets['JobAbility'] = {};
	sets['JobAbility']['Spirit Surge'] = {body="Ptero. Mail +1", };
	sets['JobAbility']['Call Wyvern'] = {body="Ptero. Mail +1",  };
	sets['JobAbility']['Ancient Circle'] = { legs="Vishap Brais +2",};
	...
	sets['JobAbility']['Spirit Link'] = { head="Vishap Armet +2",};
	sets['JobAbility']['High Jump'] = set_combine(sets['JobAbility']['Jump'],{ legs="Vishap Brais +2",});
	sets['JobAbility']['Super Jump'] = set_combine(sets['JobAbility']['Jump'],{ });
	sets['JobAbility']['Deep Breathing'] = { };
	sets['JobAbility']['Angon'] = { ammo="Angon",};
	sets['JobAbility']['Spirit Jump'] = set_combine(sets['JobAbility']['Jump'],{ });
	sets['JobAbility']['Soul Jump'] = set_combine(sets['JobAbility']['Jump'],{ });
	sets['JobAbility']['Dragon Breaker'] = { };
	sets['JobAbility']['Fly High'] = set_combine(sets['JobAbility']['Jump'],{ });
	...
	--needs to be PetCommand and the pet ability name for dragoon atleast		
	--uncomment the print in aftercast to find out	
	sets['precast']['PetCommand'] = {};
	sets['precast']['PetCommand']['Restoring Breath'] = {head="Vishap Armet +2", };
	-- sets['precast']['PetCommand']['Smiting Breath'] = {head="Vishap Armet +2", };
	sets['precast']['PetCommand']['Steady Wing'] = sets['precast']['PetCommand']['Restoring Breath']
	
	--Midcast--
	
	sets['midcast'] = {};									
	sets['midcast']['Trust'] = {body="Sylvie Unity shirt",};
	
	-- needs to be BloodPactRage and the actual name of the move the pet is doing i.e. restoring breath is actually Healing Breath IV.
	--uncomment the print in pet_midcast to find out
	sets['midcast']['BloodPactRage'] = {};
	--set for Restoring Breath
	sets['midcast']['BloodPactRage']['Healing Breath IV'] = {head="Ptero. Armet +1",legs="Vishap Brais +2",feet="Ptero. Greaves +1", waist="Chaac Belt",};
	
	--sets for Smiting Breath
	-- sets['midcast']['BloodPactRage']['Flame Breath'] = {head="Ptero. Armet +1",legs="Vishap Brais +2",feet="Ptero. Greaves +1", };
	-- sets['midcast']['BloodPactRage']['Frost Breath'] = sets['midcast']['BloodPactRage']['Flame Breath']
	-- sets['midcast']['BloodPactRage']['Gust Breath'] = sets['midcast']['BloodPactRage']['Flame Breath']
	-- sets['midcast']['BloodPactRage']['Sand Breath'] = sets['midcast']['BloodPactRage']['Flame Breath']
	-- sets['midcast']['BloodPactRage']['Lightning Breath'] = sets['midcast']['BloodPactRage']['Flame Breath']
	-- sets['midcast']['BloodPactRage']['Hydro Breath'] = sets['midcast']['BloodPactRage']['Flame Breath']
	...
	sets['Status-Overrides']['Sleep'] = {neck="Vim Torque +1"};
	...
	windower.send_command('input /echo [ Job Changed to Dragoon ]')  --change to the job your using--
	windower.send_command('wait 1; input //jc sub SAM') -- changes subjob to sam
	windower.send_command('wait 5; input /lockstyleset 12')  -- need to make lockstyle --
	windower.send_command('input /macro book 10; wait .1; input /macro set 1')  -- changes macro pallet to jerb --
	...
	-- you can use "/console gs c jump" to activate a cylce of jumps 
end
...
function precast(spell)
	--------------------------------------------------------------------------------------------------------------------------------------------------->
	-- checks for jump distance and cancels if to far away
	if spell.target.distance >= 10 and spell.english:endswith('Jump') then
		cancel_spell()
		return
	end	
...
function self_command(command)
	...
	-- jump logic for cycling jumps from top to bottom based on recast
	if command == 'jump' then
		if windower.ffxi.get_ability_recasts()[158] < 1 then
			windower.send_command('input /ja "Jump" <t>')
			elseif windower.ffxi.get_ability_recasts()[159] < 1 then
				windower.send_command('input /ja "High Jump" <t>')
			elseif windower.ffxi.get_ability_recasts()[166] < 1 then
				windower.send_command('input /ja "Spirit Jump" <t>')
			elseif windower.ffxi.get_ability_recasts()[167] < 1 then
				windower.send_command('input /ja "Soul Jump" <t>')
			elseif windower.ffxi.get_ability_recasts()[254] < 1 then
				windower.send_command('input /ja "Fly High" <me>')
			else
